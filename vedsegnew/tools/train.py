...
print('filename==',os.path.dirname(__file__))
os.path.join('/traindata/segproj/vedsegnew/')
from vedaseg.runners import TrainRunner
from vedaseg.utils import Config

def parse_args():
    parser = argparse.ArgumentParser(description='Train a segmentation model')
    parser.add_argument('--config', default='/traindata/segproj/vedsegnew/configs/coco_dpv3plusres50.py',type=str, help='config file path')
